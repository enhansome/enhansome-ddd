...
* [Awesome Domain-Driven Design](https://github.com/heynickc/awesome-ddd/) ⭐ 12,323 | 🐛 4 | 📅 2026-08-10
  * [Contents](#contents)
  * [Books](#books)
...
* [Awesome Event Storming](https://github.com/mariuszgil/awesome-eventstorming) ⭐ 2,389 | 🐛 6 | 📅 2024-10-23 - awesome list that focuses only on Event Storming.
...
* [Domain-Driven Design in dynamic languages GitHub](https://github.com/valignatev/ddd-dynamic) ⭐ 1,401 | 🐛 3 | 📅 2023-06-08 - GitHub's profile of Domain-Driven Design in dynamic languages.
...
* [DDD by Refactoring](https://github.com/ThreeDotsLabs/wild-workouts-go-ddd-example) ⭐ 6,409 | 🐛 30 | 🌐 Go | 📅 2025-11-03 - Complete serverless application to show how to apply DDD, Clean Architecture, and CQRS by practical refactoring of a Go project. A full blog series about it can be found at <https://threedots.tech/>.
...
* [Go DDD Template](https://github.com/sklinkert/go-ddd) ⭐ 798 | 🐛 8 | 🌐 Go | 📅 2026-08-14 - Production-grade DDD and CQRS template with value objects, race-safe idempotent commands, domain events with a transactional outbox, and a tutorial series teaching DDD from zero.
...
* [Modular Monolith](https://github.com/kgrzybek/modular-monolith-with-ddd) ⭐ 13,939 | 🐛 68 | 🌐 C# | 📅 2024-06-04 - Full Modular Monolith .NET application with Domain-Driven Design approach.
...
* [TodoMVC-DDD-CQRS-EventSourcing](https://github.com/volak/TodoMVC-DDD-CQRS-EventSourcing) ⭐ 256 | 🐛 2 | 🌐 C# | 📅 2023-01-08 - Implementation of basic Todo app via tastejs/todomvc in C#/Typescript with eventsourcing, cqrs, and domain driven design
...
* [CQRS-DDD Example](https://github.com/dcomartin/DDD-CQRS-ES-Example) ⭐ 133 | 🐛 0 | 🌐 JavaScript | 📅 2014-05-01 - Domain Driven Design, CQRS, & Event Sourcing Example using GetEventStore, CommonDomain, NServiceBus, Entity Framework, SQL Server, SignalR.
...
* [DDD By Examples - Library](https://github.com/ddd-by-examples/library) ⭐ 5,839 | 🐛 23 | 🌐 Java | 📅 2023-07-07 - sample project of a library driven by real business requirements. Modular monolith implemented with the help od DDD, BDD, EventStorming, Example Mapping, CQRS, and more.
...
* [Casino Engine](https://github.com/nekzabirov/IGaming-Game-Engine) ⭐ 19 | 🐛 0 | 🌐 Kotlin | 📅 2026-08-14 - Production iGaming/casino engine in Kotlin/Ktor demonstrating Hexagonal Architecture with DDD and CQRS. Aggregates raise domain events, repository ports live in the domain layer, command and query handlers are wired through a Koin-discovered registry, and domain events are published to RabbitMQ after the write transaction commits. Apache 2.0.

### PHP

* [Symfony 5 DDD ES CQRS backend](https://github.com/jorge07/symfony-5-es-cqrs-boilerplate) ⭐ 1,089 | 🐛 3 | 🌐 PHP | 📅 2026-08-09 - DDD, CQRS and Event Sourcing app using Symfony and PHP 8.
* [Eric Evans DDD Cargo Sample](https://github.com/codeliner/php-ddd-cargo-sample) ⭐ 789 | 🐛 0 | 🌐 JavaScript | 📅 2018-11-06 - PHP 7 Version of the cargo sample used in Eric Evans DDD book
...
* [Ginkgo](https://github.com/onsi/ginkgo) ⭐ 9,041 | 🐛 126 | 🌐 Go | 📅 2026-08-10 - Ginkgo builds on Go's testing package, allowing expressive Behavior-Driven Development ("BDD") style tests.
...
* [Godog](https://github.com/cucumber/godog) ⭐ 2,659 | 🐛 89 | 🌐 Go | 📅 2026-08-13 - Package godog is the official Cucumber BDD framework for Golang, it merges specification and test documentation into one cohesive whole, using Gherkin formatted scenarios in the format of Given, When, Then.
...
* [NServiceBus](https://github.com/Particular/NServiceBus) ⭐ 2,167 | 🐛 289 | 🌐 C# | 📅 2026-08-14 - Service bus for .NET.
...
* [Ahoo-Wang/Wow](https://github.com/Ahoo-Wang/Wow) ⭐ 303 | 🐛 8 | 🌐 Kotlin | 📅 2026-08-14 - A Modern Reactive CQRS Architecture Microservice development framework based on DDD and EventSourcing.
...
* [DDD Toolbox](https://dddtoolbox.com) - Open-source collection of modern web-based tools including Domain Storytelling and Event Storming ([Source Code](https://github.com/poulainpi/ddd-toolbox) ⭐ 383 | 🐛 8 | 🌐 TypeScript | 📅 2026-08-05).
