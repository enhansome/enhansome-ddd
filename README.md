...
* [Awesome Domain-Driven Design](https://github.com/heynickc/awesome-ddd/) ⭐ 12,375 | 🐛 2 | 📅 2026-08-26
  * [Contents](#contents)
  * [Books](#books)
...
* [Context Mapping by ddd-crew](https://github.com/ddd-crew/context-mapping) ⭐ 1,859 | 🐛 9 | 📅 2026-08-23 - 	Context Mapping Cheatsheet and Starter Kit by ddd-crew.
...
* [DDD by Refactoring](https://github.com/ThreeDotsLabs/wild-workouts-go-ddd-example) ⭐ 6,461 | 🐛 30 | 🌐 Go | 📅 2026-08-27 - Complete serverless application to show how to apply DDD, Clean Architecture, and CQRS by practical refactoring of a Go project. A full blog series about it can be found at <https://threedots.tech/>.
...
* [Go DDD Template](https://github.com/sklinkert/go-ddd) ⭐ 811 | 🐛 10 | 🌐 Go | 📅 2026-09-14 - Production-grade DDD and CQRS template with value objects, race-safe idempotent commands, domain events with a transactional outbox, and a tutorial series teaching DDD from zero.
...
* [Modular Monolith](https://github.com/kgrzybek/modular-monolith-with-ddd) ⭐ 14,035 | 🐛 68 | 🌐 C# | 📅 2024-06-04 - Full Modular Monolith .NET application with Domain-Driven Design approach.
...
* [Ginkgo](https://github.com/onsi/ginkgo) ⭐ 9,060 | 🐛 124 | 🌐 Go | 📅 2026-09-22 - Ginkgo builds on Go's testing package, allowing expressive Behavior-Driven Development ("BDD") style tests.
...
* [Godog](https://github.com/cucumber/godog) ⭐ 2,675 | 🐛 92 | 🌐 Go | 📅 2026-09-19 - Package godog is the official Cucumber BDD framework for Golang, it merges specification and test documentation into one cohesive whole, using Gherkin formatted scenarios in the format of Given, When, Then.
* [GOBDD](https://github.com/go-bdd/gobdd) ⭐ 145 | 🐛 10 | 🌐 Go | 📅 2026-09-21 - Small BDD framework for GO.

### .NET

* [MediatR](https://github.com/jbogard/MediatR) ⭐ 11,859 | 🐛 3 | 🌐 C# | 📅 2026-07-02 - Supports request/response, commands, queries, notifications and events, synchronous and async with intelligent dispatching via C# generic variance.
...
* [NServiceBus](https://github.com/Particular/NServiceBus) ⭐ 2,171 | 🐛 289 | 🌐 C# | 📅 2026-09-24 - Service bus for .NET.
...
* [Stratara](https://github.com/yesbert/Stratara) ⭐ 3 | 🐛 0 | 🌐 C# | 📅 2026-09-23 - CQRS and Event Sourcing framework for .NET with tamper-evident streams and tenant-aware encryption, plus integrated mediator, outbox, sagas and projections.
...
* [Ahoo-Wang/Wow](https://github.com/Ahoo-Wang/Wow) ⭐ 303 | 🐛 7 | 🌐 TypeScript | 📅 2026-09-24 - A Modern Reactive CQRS Architecture Microservice development framework based on DDD and EventSourcing.
...
* [DDD Toolbox](https://dddtoolbox.com) - Open-source collection of modern web-based tools including Domain Storytelling and Event Storming ([Source Code](https://github.com/poulainpi/ddd-toolbox) ⭐ 390 | 🐛 8 | 🌐 TypeScript | 📅 2026-08-05).
