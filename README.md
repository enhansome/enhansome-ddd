...
* [Context Mapping by ddd-crew](https://github.com/ddd-crew/context-mapping) ⭐ 1,839 | 🐛 11 | 📅 2026-08-01 - 	Context Mapping Cheatsheet and Starter Kit by ddd-crew.
...
* [DDD by Refactoring](https://github.com/ThreeDotsLabs/wild-workouts-go-ddd-example) ⭐ 6,408 | 🐛 30 | 🌐 Go | 📅 2025-11-03 - Complete serverless application to show how to apply DDD, Clean Architecture, and CQRS by practical refactoring of a Go project. A full blog series about it can be found at <https://threedots.tech/>.
...
* [Go DDD Template](https://github.com/sklinkert/go-ddd) ⭐ 797 | 🐛 9 | 🌐 Go | 📅 2026-08-10 - Production-grade DDD and CQRS template with value objects, race-safe idempotent commands, domain events with a transactional outbox, and a tutorial series teaching DDD from zero.
...
* [DDDInventoryItemFSharp](https://github.com/eulerfx/DDDInventoryItemFSharp) ⭐ 187 | 🐛 4 | 🌐 JavaScript | 📅 2021-03-02 - An idiomatic F# implementation of Domain-Driven Design
...
* [Stringly.Typed](https://github.com/mission202/Stringly.Typed) ⭐ 49 | 🐛 4 | 🌐 C# | 📅 2018-11-20 - Making it easier to convert strings to/from .NET types.
...
* [Commanded](https://github.com/slashdotdash/commanded) ⭐ 2,029 | 🐛 13 | 🌐 Elixir | 📅 2026-07-27 - Command handling middleware for CQRS/ES applications, Pure Functional Data Structures for Aggregates and Process Managers, Point-to-Point message routing, and much more in Elixir (Erlang VM) - All in Actor concurrency model.
