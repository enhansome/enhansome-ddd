...
* [Awesome Domain-Driven Design](https://github.com/heynickc/awesome-ddd/) ⭐ 12,369 | 🐛 1 | 📅 2026-08-26
  * [Contents](#contents)
  * [Books](#books)
...
* [Awesome Event Storming](https://github.com/mariuszgil/awesome-eventstorming) ⭐ 2,401 | 🐛 6 | 📅 2024-10-23 - awesome list that focuses only on Event Storming.
* [Context Mapping by ddd-crew](https://github.com/ddd-crew/context-mapping) ⭐ 1,855 | 🐛 9 | 📅 2026-08-23 - 	Context Mapping Cheatsheet and Starter Kit by ddd-crew.
...
* [DDD by Refactoring](https://github.com/ThreeDotsLabs/wild-workouts-go-ddd-example) ⭐ 6,458 | 🐛 30 | 🌐 Go | 📅 2026-08-27 - Complete serverless application to show how to apply DDD, Clean Architecture, and CQRS by practical refactoring of a Go project. A full blog series about it can be found at <https://threedots.tech/>.
...
* [Modular Monolith](https://github.com/kgrzybek/modular-monolith-with-ddd) ⭐ 14,022 | 🐛 68 | 🌐 C# | 📅 2024-06-04 - Full Modular Monolith .NET application with Domain-Driven Design approach.
...
* [Event Sourcing .NET](https://github.com/oskardudycz/EventSourcing.NetCore) ⭐ 3,683 | 🐛 25 | 🌐 C# | 📅 2026-09-17 - samples and resources about Event Sourcing and CQRS in .NET. Contains also a self-paced kit of how to built own Event Store
...
* [DDD By Examples - Library](https://github.com/ddd-by-examples/library) ⭐ 5,862 | 🐛 18 | 🌐 Java | 📅 2026-09-17 - sample project of a library driven by real business requirements. Modular monolith implemented with the help od DDD, BDD, EventStorming, Example Mapping, CQRS, and more.
...
* [Godog](https://github.com/cucumber/godog) ⭐ 2,672 | 🐛 92 | 🌐 Go | 📅 2026-09-17 - Package godog is the official Cucumber BDD framework for Golang, it merges specification and test documentation into one cohesive whole, using Gherkin formatted scenarios in the format of Given, When, Then.
...
* [NServiceBus](https://github.com/Particular/NServiceBus) ⭐ 2,170 | 🐛 291 | 🌐 C# | 📅 2026-09-17 - Service bus for .NET.
...
* [Stratara](https://github.com/yesbert/Stratara) ⭐ 3 | 🐛 6 | 🌐 C# | 📅 2026-09-17 - CQRS and Event Sourcing framework for .NET with tamper-evident streams and tenant-aware encryption, plus integrated mediator, outbox, sagas and projections.
...
* [Ahoo-Wang/Wow](https://github.com/Ahoo-Wang/Wow) ⭐ 302 | 🐛 6 | 🌐 Kotlin | 📅 2026-09-17 - A Modern Reactive CQRS Architecture Microservice development framework based on DDD and EventSourcing.
